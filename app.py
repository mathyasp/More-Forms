...
def compliments_results():
    ...
    context = {
        ...
        'compliments_sublist': random.sample(list_of_compliments, int(request.args.get('num_compliments'))),
    }
...
def animal_facts():
    ...
    context = {
        ...
        'chosen_fact': animal_to_fact.get(request.args.get('animal')),
    }
...
def image_filter():
    ...
    if request.method == 'POST':
        ...
        filter_applied = apply_filter(file_path, filter_type)
...
def gif_search():
    ...
    if request.method == 'POST':
        ...
        qty_gifs = request.form.get('quantity')

        response = requests.get(
            TENOR_URL % (search_query, API_KEY, "app", qty_gifs),
        )
